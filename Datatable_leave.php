    ...
    protected function produce_output($charset)
    {
	  ...
	  $dat=$rResult->result_array();
		foreach($dat as $results){
		  $url_param = $results['trn_hdr_id'];
		 $dat[$i]['view']='<a class="mm_view" id="view" onclick="view_empl(this)" name="'.base_url().'index.php/leave/emp_view/'.$url_param.'" href="#">View</i></a>'; 
		  $dat[$i]['action']='<a href="#" onclick="add_leave(this)" class="add_emp_edit ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="create-user" name="'.base_url().'index.php/leave/add_empl/'.$url_param.'"><span class="ui-button-text"><i class="icon-edit"></i></span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="'.base_url().'index.php/leave/delete/'.$url_param.'" role="button" data-toggle="modal"><i class="icon-remove"></i></a>'; 
